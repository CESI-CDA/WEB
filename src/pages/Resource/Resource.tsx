                ...
                {resourceData && (
                    <>
                        ...
                        <p className={styles.category}>
                            ...
                            <p className={styles.typeOfRelation}>Types de relation : {resourceData?.item.get_lien_ressource_relation.map((lien: { get_relation_ressource: { intitule_rel: string } }) => lien.get_relation_ressource.intitule_rel).join(" / ")}</p>
