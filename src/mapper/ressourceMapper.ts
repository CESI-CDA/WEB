...
,     title: d.titre_res ? d.titre_res : "N/A",
      ...
      relation: d?.get_lien_ressource_relation ? d.get_lien_ressource_relation.map((c: any) => {
        return c.get_relation_ressource.intitule_rel;
      }) : [RessourceRelation.INCONNUE],
      categorie: d?.get_lien_ressource_categorie ? d.get_lien_ressource_categorie.map((c: any) => {
